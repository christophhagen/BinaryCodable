...
final class ArrayEncodingTests: XCTestCase {
    ...
    func testBoolArrayEncoding() throws {
        ...
        try compare([true, false, false], to: [1, 0, 0])
        try compare([false, true, true], to: [0, 1, 1])
    }
    ...
    func testInt8Encoding() throws {
        ...
        try compare([.zero, 123, .min, .max, -1], to: [0, 123, 128, 127, 255])
    }
    ...
    func testInt16Encoding() throws {
        ...
        try compare([.zero, 123, .min, .max, -1], to: [0, 0, 123, 0, 0, 128, 255, 127, 255, 255])
    }
    ...
    func testInt32Encoding() throws {
        ...
        try compare([.zero, 123, .min, .max, -1], to: [0, 123, 128, 128, 128, 128, 8, 255, 255, 255, 255, 7, 255, 255, 255, 255, 15])
    }
    ...
    func testInt64Encoding() throws {
        ...
        try compare([0, 123, .max, .min, -1], to: [0, 123, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])
    }
    ...
    func testUInt8Encoding() throws {
        ...
        try compare([.zero, 123, .min, .max], to: [0, 123, 0, 255])
    }
    ...
    func testUInt16Encoding() throws {
        ...
        try compare([.zero, 123, .min, .max, 12345], to: [0, 0, 123, 0, 0, 0, 255, 255, 0x39, 0x30])
    }
    ...
    func testUInt32Encoding() throws {
        ...
        try compare([.zero, 123, .min, 12345, 123456, 12345678, 1234567890, .max],
                    to: [0, 123, 0, 0xB9, 0x60, 0xC0, 0xC4, 0x07, 0xCE, 0xC2, 0xF1, 0x05, 0xD2, 0x85, 0xD8, 0xCC, 0x04, 255, 255, 255, 255, 15])
    }
    ...
    func testUInt64Encoding() throws {
        ...
        try compare([0, 123, .min, 12345, 123456, 12345678, 1234567890, 12345678901234, .max],
                    to: [0, 123, 0, 0xB9, 0x60, 0xC0, 0xC4, 0x07, 0xCE, 0xC2, 0xF1, 0x05, 0xD2, 0x85, 0xD8, 0xCC, 0x04, 0xF2, 0xDF, 0xB8, 0x9E, 0xA7, 0xE7, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])
    }
